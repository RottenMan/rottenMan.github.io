...
```javascript
let [,url]=['小夜勃','title.com'];
console.log(url);//title.com
```

使用展开语法获取多个值

```javascript
let [name, ...arr] = ['小夜勃', 'object', 'title.com'];
console.log(name, arr); //小夜勃 (2) ["object", "title.com"]
```
...
```javascript
let arr = [1, "小夜勃", "object"];
arr[arr.length] = 'title.com';
console.log(arr); //[1, "小夜勃", "object", "title.com"]
```
...
let hd = ["title"];
hd.push(...arr);
console.log(hd); //["title", "小夜勃", "object"]
```
...
```javascript
let arr = ["小夜勃", "object"];
console.log(arr.push('向军大叔', 'title')); //4
console.log(arr); //["小夜勃", "object", "向军大叔", "title"]
```
...
```javascript
let arr = ["小夜勃", "object"];
console.log(arr.unshift('向军大叔', 'title')); //4
console.log(arr); //["向军大叔", "title", "小夜勃", "object"]
```
...
```javascript
let array = ["object", "title"];
let hd = [1, 2];
let cms = [3, 4];
console.log(array.concat(hd, cms)); //["object", "title", 1, 2, 3, 4]
```
...
```javascript
const hd = ['title', 'object'];
const iterator = hd.entries();
console.log(iterator.next()); //value:{0:0,1:'title'}
